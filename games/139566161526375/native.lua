-- Imported from Vape V4 game layer: 139566161526375

-- source: bridge duel\139566161526375 - game\base.lua
...
-- source: bridge duel\139566161526375 - game\Blatant\Criticals.lua
local old
...
-- source: bridge duel\139566161526375 - game\Blatant\InvMove.lua
local old
...
-- source: bridge duel\139566161526375 - game\Blatant\Killaura.lua
local Killaura
local Targets
local CPS
local SwingRange
...
-- source: bridge duel\139566161526375 - game\Blatant\NoFall.lua
local old
...
-- source: bridge duel\139566161526375 - game\Blatant\NoSlowdown.lua
local old
...
-- source: bridge duel\139566161526375 - game\Blatant\ProjectileAimbot.lua
local TargetPart
local FOV
local old
...
-- source: bridge duel\139566161526375 - game\Combat\AutoClicker.lua
local AutoClicker
local CPS
...
-- source: bridge duel\139566161526375 - game\Combat\Reach.lua
--[[local old
...
-- source: bridge duel\139566161526375 - game\Combat\Velocity.lua
local Velocity
local Horizontal
local Vertical
local Chance
...
-- source: bridge duel\139566161526375 - game\Inventory\AutoBuy.lua
local AutoBuy
local Sword
local Armor
local Upgrades
...
-- source: bridge duel\139566161526375 - game\Utility\AutoPlay.lua
local AutoPlay
local Delay
...
-- source: bridge duel\139566161526375 - game\Utility\Scaffold.lua
local Scaffold
local Expand
local Tower
local Downwards
...
-- source: bridge duel\139566161526375 - game\World\Breaker.lua
local Breaker
local Value
local OnlyPlayer
