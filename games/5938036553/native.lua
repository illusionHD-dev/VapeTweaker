-- Imported from Vape V4 game layer: 5938036553

-- source: frontlines\5938036553 - game\base.lua
...
-- source: frontlines\123804558118054 - versus.lua
local vape = shared.vape
local loadstring = function(...)
	local res, err = loadstring(...)
	if err and vape then
...
-- source: frontlines\131465939650733 - versus ffa.lua
local vape = shared.vape
local loadstring = function(...)
	local res, err = loadstring(...)
	if err and vape then
...
-- source: frontlines\5938036553 - game\Blatant\GrenadeTP.lua
local GrenadeTP
local Range
...
-- source: frontlines\5938036553 - game\Blatant\GunModifications.lua
local Reload
local Recoil
local Spread
local FireRate
...
-- source: frontlines\5938036553 - game\Blatant\Killaura.lua
local Killaura
local Targets
local SwingRange
local AttackRange
...
-- source: frontlines\5938036553 - game\Blatant\Phase.lua
local Phase
...
-- source: frontlines\5938036553 - game\Blatant\SpinBot.lua
local SpinBot
local Speed
local Yaw
local Pitch
...
-- source: frontlines\5938036553 - game\Combat\AimAssist.lua
local AimAssist
local FOV
local Speed
local CircleColor
...
-- source: frontlines\5938036553 - game\Combat\SilentAim.lua
local SilentAim
local Target
local Mode
local Range
...
-- source: frontlines\5938036553 - game\Combat\Sprint.lua
local Sprint
...
-- source: frontlines\5938036553 - game\Legit\BulletTracers.lua
local BulletTracers
local Material
local Color
local Lifetime
...
-- source: frontlines\5938036553 - game\Render\GrenadeESP.lua
local GrenadeESP
local Background
local Color = {}
local Reference = {}
...
-- source: frontlines\5938036553 - game\Render\NoHurtCam.lua
local NoHurtCam
...
-- source: frontlines\5938036553 - game\Render\ThirdPerson.lua
local ThirdPerson
local Distance
local hook = false
...
-- source: frontlines\5938036553 - game\Utility\AutoRespawn.lua
local AutoRespawn
...
-- source: frontlines\5938036553 - game\Utility\ChatSpammer.lua
local ChatSpammer
local Lines
local Mode
local Delay
...
-- source: frontlines\5938036553 - game\Utility\PickupRange.lua
local PickupRange
local Range
...
-- source: frontlines\83413351472244 - versus ffa2.lua
local vape = shared.vape
local loadstring = function(...)
	local res, err = loadstring(...)
	if err and vape then
