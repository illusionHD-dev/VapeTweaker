-- Imported from Vape V4 game layer: 115875349872417

-- source: redliner\115875349872417 - game\base.lua
...
-- source: redliner\115875349872417 - game\Blatant\AntiParry.lua
local AntiParry
local anims = {
...
-- source: redliner\115875349872417 - game\Blatant\AutoParry.lua
local AutoParry
...
-- source: redliner\115875349872417 - game\Blatant\Fly.lua
local Fly
local LongJump
run(function()
	local UpKey
...
-- source: redliner\115875349872417 - game\Blatant\HighJump.lua
local HighJump
local Value
...
-- source: redliner\115875349872417 - game\Blatant\InfiniteDash.lua
local InfiniteDash
...
-- source: redliner\115875349872417 - game\Blatant\Killaura.lua
local Killaura
local Targets
local AttackRange
local AngleSlider
...
-- source: redliner\115875349872417 - game\Combat\Reach.lua
local Reach
...
-- source: redliner\115875349872417 - game\Combat\SilentAim.lua
local SilentAim
local Target
local Range
local HitChance
...
-- source: redliner\115875349872417 - game\Legit\HitSound.lua
local HitSound
local Value
local Volume
local PitchShift
...
-- source: redliner\115875349872417 - game\Legit\KillSound.lua
local KillSound
local Value
local Volume
local PitchShift
...
-- source: redliner\115875349872417 - game\Utility\AutoQueue.lua
local AutoQueue
...
-- source: redliner\115875349872417 - game\Utility\AutoToxic.lua
local AutoToxic
local GG
...
-- source: redliner\126691165749976 - 1v1.lua
local vape = shared.vape
local loadstring = function(...)
	local res, err = loadstring(...)
	if err and vape then
...
-- source: redliner\94987506187454 - lobby.lua
local vape = shared.vape
local loadstring = function(...)
	local res, err = loadstring(...)
	if err and vape then
