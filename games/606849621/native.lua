-- Imported from Vape V4 game layer: 606849621

-- source: jailbreak\606849621 - main\base.lua
...
-- source: jailbreak\606849621 - main\Blatant\AutoArrest.lua
local AutoArrest
local Range
local AutoEquip
local cooldown = 0
...
-- source: jailbreak\606849621 - main\Blatant\AutoEject.lua
local AutoEject
local Range
local Hand
local cooldown = 0
...
-- source: jailbreak\606849621 - main\Blatant\AutoPickpocket.lua
...
-- source: jailbreak\606849621 - main\Blatant\AutoPop.lua
local AutoPop
local Range
local TeamCheck
local hitDelays = {}
...
-- source: jailbreak\606849621 - main\Blatant\AutoPunch.lua
local AutoPunch
...
-- source: jailbreak\606849621 - main\Blatant\AutoTaze.lua
local AutoTaze
local Range
local HandCheck
local CooldownBar
...
-- source: jailbreak\606849621 - main\Blatant\Fly.lua
local Fly
local LongJump
run(function()
	local Value
...
-- source: jailbreak\606849621 - main\Blatant\ForceEquip.lua
local ForceEquip
local old
...
-- source: jailbreak\606849621 - main\Blatant\GunModifications.lua
...
-- source: jailbreak\606849621 - main\Blatant\LazerGodmode.lua
local modified = {}
...
-- source: jailbreak\606849621 - main\Blatant\LongJump.lua
local Mode
local Value
local AutoDisable
...
-- source: jailbreak\606849621 - main\Blatant\NoFall.lua
...
-- source: jailbreak\606849621 - main\Blatant\NoSlowdown.lua
local NoSlowdown
local Toggles = {}
...
-- source: jailbreak\606849621 - main\Blatant\Speed.lua
local Speed
local Value
local CustomProperties
...
-- source: jailbreak\606849621 - main\Blatant\VehicleSpeed.lua
local VehicleSpeed
local Value
local old
...
-- source: jailbreak\606849621 - main\Combat\SilentAim.lua
local SilentAim
local Target
local Mode
local Range
...
-- source: jailbreak\606849621 - main\Combat\Sprint.lua
local Sprint
...
-- source: jailbreak\606849621 - main\Inventory\AutoHeal.lua
local AutoHeal
...
-- source: jailbreak\606849621 - main\Inventory\AutoHotbar.lua
local AutoHotbar
...
-- source: jailbreak\606849621 - main\Inventory\AutoPickup.lua
local AutoPickup
local Lists = {}
local Regions = {}
...
-- source: jailbreak\606849621 - main\Legit\FPSBooster.lua
local FPSBooster
local destructibles = {}
local old
...
-- source: jailbreak\606849621 - main\Legit\Viewmodel.lua
local Viewmodel
local Depth
local Horizontal
local Vertical
...
-- source: jailbreak\606849621 - main\Utility\InfiniteNitro.lua
local oldnitro
...
-- source: jailbreak\606849621 - main\Utility\InstantAction.lua
local old
local await
