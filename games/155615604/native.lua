-- Imported from Vape V4 game layer: 155615604

-- source: prison life\155615604 - main\base.lua
...
-- source: prison life\135564683255158 - vc servers.lua
local vape = shared.vape
...
-- source: prison life\155615604 - main\Blatant\AntiInvisible.lua
local AntiInvisible
local threads = {}
local whitelist = {
...
-- source: prison life\155615604 - main\Blatant\AntiKillPlane.lua
local AntiKillPlane
...
-- source: prison life\155615604 - main\Blatant\AntiRiotShield.lua
...
-- source: prison life\155615604 - main\Blatant\AntiTaze.lua
local AntiTaze
...
-- source: prison life\155615604 - main\Blatant\AutoArrest.lua
local AutoArrest
local Range
local HandCheck
local CooldownBar
...
-- source: prison life\155615604 - main\Blatant\AutoReset.lua
local AutoReset
...
-- source: prison life\155615604 - main\Blatant\AutoTaser.lua
local AutoTaser
local Range
local VelocityCheck
local cooldown = 0
...
-- source: prison life\155615604 - main\Blatant\FenceGodmode.lua
local FenceGodmode
...
-- source: prison life\155615604 - main\Blatant\GunModifications.lua
...
-- source: prison life\155615604 - main\Blatant\Killaura.lua
local Killaura
local Targets
local AttackRange
local AngleSlider
...
-- source: prison life\155615604 - main\Blatant\NoJumpCooldown.lua
...
-- source: prison life\155615604 - main\Blatant\VehicleFly.lua
local VehicleFly
local Mode
local Speed
local welds = {}
...
-- source: prison life\155615604 - main\Blatant\VehicleSpeed.lua
local VehicleSpeed
local Speed
local old
local seats = {}
...
-- source: prison life\155615604 - main\Blatant\VehicleWallbang.lua
...
-- source: prison life\155615604 - main\Combat\SilentAim.lua
local mouseClicked
run(function()
	local SilentAim
	local Target
...
-- source: prison life\155615604 - main\Combat\TriggerBot.lua
local TriggerBot
local Targets
local rayParams = RaycastParams.new()
rayParams.CollisionGroup = 'ClientBullet'
...
-- source: prison life\155615604 - main\Inventory\AutoArmor.lua
local AutoArmor
local pickups = {}
...
-- source: prison life\155615604 - main\Inventory\AutoHeal.lua
local AutoHeal
local healItems = {
	Breakfast = true,
	Lunch = true,
...
-- source: prison life\155615604 - main\Inventory\AutoHotbar.lua
local AutoHotbar
local SortList = {}
...
-- source: prison life\155615604 - main\Inventory\AutoPickup.lua
local AutoPickup
local items = {}
...
-- source: prison life\155615604 - main\Legit\BulletTracers.lua
local BulletTracers
local Material
local Color
local Lifetime
...
-- source: prison life\155615604 - main\Legit\Crosshair.lua
local Crosshair
local Image
local old
...
-- source: prison life\155615604 - main\Legit\DamageIndicator.lua
...
-- source: prison life\155615604 - main\Legit\HitSound.lua
local HitSound
local Value
local Volume
local PitchShift
...
-- source: prison life\155615604 - main\Legit\KillSound.lua
local KillSound
local Value
local Volume
local PitchShift
...
-- source: prison life\155615604 - main\Legit\Viewmodel.lua
local Viewmodel
local Depth
local Horizontal
local Vertical
...
-- source: prison life\155615604 - main\Render\C4ESP.lua
local C4ESP
local FillColor
local OutlineColor
...
-- source: prison life\155615604 - main\Render\CameraPhase.lua
local CameraPhase
local old
...
-- source: prison life\155615604 - main\Render\KillNotifications.lua
...
-- source: prison life\155615604 - main\Utility\AutoDetonate.lua
local AutoDetonate
local SafeCheck
local localc4
local ticks = 0
...
-- source: prison life\155615604 - main\Utility\AutoReload.lua
local AutoReload
local HotSwap
...
-- source: prison life\155615604 - main\Utility\AutoToxic.lua
local AutoToxic
...
-- source: prison life\155615604 - main\Utility\CheatDetector.lua
local CheatDetector
local AddTarget
...
-- source: prison life\155615604 - main\Utility\Disabler.lua
local Disabler
local old
