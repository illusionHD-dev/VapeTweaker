-- Imported from Vape V4 game layer: 16483433878

-- source: blocktales\16483433878 - blocktales\base.lua
...
-- source: blocktales\106431012459431 - battle sim.lua
local vape = shared.vape
...
-- source: blocktales\16483433878 - blocktales\Blatant\AntiHazard.lua
local AntiHazard
local old
...
-- source: blocktales\16483433878 - blocktales\Blatant\Fly.lua
local Fly
local LongJump
run(function()
	local UpKey
...
-- source: blocktales\16483433878 - blocktales\Blatant\FlyingAttack.lua
local FlyingAttack
...
-- source: blocktales\16483433878 - blocktales\Blatant\LongJump.lua
local Value
local AutoDisable
...
-- source: blocktales\16483433878 - blocktales\Blatant\PickupTP.lua
local PickupTP
...
-- source: blocktales\16483433878 - blocktales\Blatant\Speed.lua
local Speed
local Value
...
-- source: blocktales\16483433878 - blocktales\Blatant\SpeedSpin.lua
local SpeedSpin
local Value
local old
...
-- source: blocktales\16483433878 - blocktales\Combat\AutoAction.lua
local AutoAction
local Attack
local Block
local actions = {
...
-- source: blocktales\16483433878 - blocktales\Combat\MissCooldown.lua
local MissCooldown
...
-- source: blocktales\16483433878 - blocktales\Render\PickupTracers.lua
local PickupTracers
local Color
local Transparency
local Bux
...
-- source: blocktales\16483433878 - blocktales\Utility\AutoCamel.lua
local AutoCamel
...
-- source: blocktales\16483433878 - blocktales\Utility\AutoCloudGrind.lua
...
-- source: blocktales\16483433878 - blocktales\Utility\AutoFish.lua
local AutoFish
local KeepList
local old
...
-- source: blocktales\16483433878 - blocktales\Utility\AutoPaint.lua
local AutoPaint
