-- Imported from Vape V4 game layer: 8768229691

-- source: skywars voxel\8768229691 - skywars game\base.lua
...
-- source: skywars voxel\13246639586 - skywars bridge.lua
local vape = shared.vape
...
-- source: skywars voxel\8542259458 - skywars lobby.lua
local run = function(func) 
	func() 
end
local cloneref = cloneref or function(obj) 
...
-- source: skywars voxel\8542275097 - skywars solo.lua
local vape = shared.vape
local loadstring = function(...)
	local res, err = loadstring(...)
	if err and vape then
...
-- source: skywars voxel\8592115909 - skywars duos.lua
local vape = shared.vape
local loadstring = function(...)
	local res, err = loadstring(...)
	if err and vape then
...
-- source: skywars voxel\8768229691 - skywars game\Blatant\AntiFall.lua
local AntiFall
local Mode
local Material
local Color
...
-- source: skywars voxel\8768229691 - skywars game\Blatant\InvMove.lua
local InvMove
local old
...
-- source: skywars voxel\8768229691 - skywars game\Blatant\Killaura.lua
local Killaura
local Targets
local AttackRange
local AngleCheck
...
-- source: skywars voxel\8768229691 - skywars game\Blatant\NoFall.lua
local NoFall
...
-- source: skywars voxel\8768229691 - skywars game\Blatant\NoSlowdown.lua
local old, oldcheck
...
-- source: skywars voxel\8768229691 - skywars game\Blatant\ProjectileAimbot.lua
local TargetPart
local FOV
local old, oldMobile
local rayCheck = RaycastParams.new()
...
-- source: skywars voxel\8768229691 - skywars game\Blatant\ProjectileAura.lua
...
-- source: skywars voxel\8768229691 - skywars game\Combat\AutoClicker.lua
local AutoClicker
local CPS
local Blocks
...
-- source: skywars voxel\8768229691 - skywars game\Combat\Sprint.lua
local Sprint
local old
...
-- source: skywars voxel\8768229691 - skywars game\Combat\Velocity.lua
local Velocity
local Horizontal
local Vertical
local Chance
...
-- source: skywars voxel\8768229691 - skywars game\Inventory\AutoBuy.lua
local AutoBuy
local Sword
local Armor
local Pickaxe
...
-- source: skywars voxel\8768229691 - skywars game\Inventory\AutoConsume.lua
local AutoConsume
...
-- source: skywars voxel\8768229691 - skywars game\Legit\Viewmodel.lua
local Viewmodel
local oldtool
...
-- source: skywars voxel\8768229691 - skywars game\Utility\Scaffold.lua
local Scaffold
local Expand
local Tower
local Downwards
...
-- source: skywars voxel\8768229691 - skywars game\World\Breaker.lua
local Breaker
local Range
local BreakerPart
local BreakerUI
...
-- source: skywars voxel\8768229691 - skywars game\World\ChestSteal.lua
local ChestSteal
local Range
local Open
local Delay = {}
...
-- source: skywars voxel\8951451142 - skywars egg squad.lua
local vape = shared.vape
local loadstring = function(...)
	local res, err = loadstring(...)
	if err and vape then
